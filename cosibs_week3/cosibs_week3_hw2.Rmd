...
```
This means that 2.54% of $p$-values (or 254 out of the total 10,000) are NOT greater than 0.05.
...
Our null hypothesis is that there is no evidence of a difference between the two population means. Much like in the previous homework (HW #1), the vast majority of $p$-values had a value *greater* than 0.05 (9,746 out of 10,000 to be exact). Therefore we fail to observe a statistically significant difference between the two sample means, and thus fail to reject the null hypothesis.
