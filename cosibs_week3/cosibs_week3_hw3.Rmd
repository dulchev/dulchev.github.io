...
```
This means that 43.68% of the $p$-values (or 4,368 out of the total 10,000) DO NOT reject the null hypothesis (i.e., 56.32% of the $p$-values DO reject the null hypothesis).
