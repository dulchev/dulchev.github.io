...
```
This means that only 11.51% of the $p$-values (or 704 out of the total 10,000) DO NOT reject the null hypothesis (i.e., 88.49% of the $p$-values DO reject the null hypothesis).
