...
```
This means that 3.3% of the $p$-values (or 33 out of the total 10,000) DO NOT reject the null hypothesis (i.e., 96.7% of the $p$-values DO reject the null hypothesis).
