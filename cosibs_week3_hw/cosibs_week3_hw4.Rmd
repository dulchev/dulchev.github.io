...
```
This means that 60.06% of the $p$-values (or 6,006 out of the total 10,000) DO NOT reject the null hypothesis (i.e., only 39.94% of the $p$-values DO reject the null hypothesis).
