...
##### D. Perform a $t$-test to compare the two sample means with a two-sided significance level of 0.05.
```{R}
...
```
This means that only 1.32% of the $p$-values (or 132 out of the total 10,000) DO NOT reject the null hypothesis (i.e., 98.68% of the $p$-values DO reject the null hypothesis).
