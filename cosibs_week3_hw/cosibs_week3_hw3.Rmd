...
```
This means that 30.09% of the $p$-values (or 3,009 out of the total 10,000) DO NOT reject the null hypothesis (i.e., 69.91% of the $p$-values DO reject the null hypothesis).
